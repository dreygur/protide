...
impl Render for MainWindow {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .on_action(cx.listener(|this, _: &ShowHelp, _, cx| { this.close_all_overlays(); this.show_help = true; cx.notify(); }))
            .on_action(cx.listener(|this, _: &ShowAbout, _, cx| { this.close_all_overlays(); this.show_about = true; cx.notify(); }))
