...
impl<E: WebSocketExecutor> RequestPanel<E> {
    ...
    fn render_websocket_messages_tab(&mut self, cx: &mut Context<Self>) -> gpui::AnyElement {
        ...
        // Send button: matches global toolbar button style
        ...
        div()
            ...
            .flex()
            .flex_col()
            // Mouse events for compose resize drag
            .on_mouse_move(cx.listener(|this, event: &MouseMoveEvent, _, cx| {
            ...
            // Message history (flex_1 — fills all space above compose)
            .child(
                div()
            ...
            .child(
                div()
                    ...
                    // Editor (fills remaining compose height)
                    .child(
                        div()
                            .flex_1()
                            .min_h(px(0.0))
