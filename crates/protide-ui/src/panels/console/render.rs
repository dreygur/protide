...
use gpui::{
    ClipboardItem, FontWeight, KeyDownEvent, MouseButton, Render, SharedString, Window, div,
    prelude::*, px,
};
...
fn render_header(
    ...
    use crate::components::icons::{ICON_CLOSE, ICON_SM, icon};
    div()
        .w_full()
        .h(px(32.0))
        .flex()
        ...
        .child(
            div()
                ...
                .text_size(px(9.0))
                .font_weight(FontWeight::BOLD)
                .text_color(if panel.show_system {
                    theme.colors.info
                } else {
                    theme.colors.text_muted.opacity(0.5)
                })
...
fn render_context_menu(
    ...
    use crate::components::icons::{ICON_COPY, ICON_ELLIPSIS, ICON_SM, icon};
