...
use crate::components::icons::{ICON_PLAY, ICON_SM, icon};
use crate::theme;
...
impl<E: WebSocketExecutor> RequestPanel<E> {
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .overflow_hidden()
                    .child(
                        gpui_component::input::Input::new(&self.graphql_query_editor)
                            .appearance(false)
                            .h_full(),
                    ),
            )
    ...
    pub(super) fn render_graphql_variables_tab(
        &mut self,
        cx: &mut Context<Self>,
    ) -> gpui::AnyElement {
        let theme = theme::current(cx);
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .overflow_hidden()
                    .child(
                        gpui_component::input::Input::new(&self.graphql_variables_editor)
                            .appearance(false)
                            .h_full(),
                    ),
            )
