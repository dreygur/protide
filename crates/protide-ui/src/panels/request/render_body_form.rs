    ...
    pub(super) fn render_form_body(&mut self, cx: &mut Context<Self>) -> gpui::AnyElement {
        ...
        container = container.child(
            div()
                ...
                .child(self.render_body_type_btn_form(
                    "body-type-json-form",
                    "JSON",
                    BodyType::Json,
                    cx,
            ...
            container = container.child(
                div()
                    ...
                    .when(!is_file_type, |el| {
                        el.child(self.render_kv_input_flex(
                            format!("form-value-{}", i),
