...
use crate::components::icons::{ICON_CHECK, ICON_CLOSE, ICON_MENU, ICON_SM, icon};
...
impl<E: WebSocketExecutor> RequestPanel<E> {
    ...
    pub(super) fn render_count_badge(
        &self,
        count: usize,
        suffix: &str,
        cx: &Context<Self>,
    ...
    pub(super) fn render_kv_row_drag_handle(
        &self,
        list: KvList,
        row: usize,
        cx: &Context<Self>,
    ...
    pub(super) fn render_form_row_drag_handle(
        &self,
        row: usize,
        cx: &Context<Self>,
    ) -> impl IntoElement {
    ...
    pub(super) fn render_kv_table_header(
        &self,
    ...
    pub(super) fn render_kv_checkbox(
        &self,
        id: SharedString,
        is_enabled: bool,
        cx: &Context<Self>,
        ...
        div()
            ...
            .justify_center()
            .when(is_enabled, |el| {
                el.child(div().flex().items_center().justify_center().child(icon(
                    ICON_CHECK,
                    ICON_SM,
    ...
    pub(super) fn render_kv_remove_btn(
        &self,
        id: SharedString,
        can_remove: bool,
        cx: &Context<Self>,
    ...
    pub(super) fn render_kv_add_btn(
        &self,
        id: &'static str,
        label: &'static str,
        cx: &Context<Self>,
                    ...
                    move |bounds, _, cx| {
                        entity.update(cx, |this, _| {
                            this.edit_input_origins
                                .insert(target, f32::from(bounds.origin.x) + 8.0);
                        });
                    },
                    |_, _, _, _| {},
                )
            ...
            .child({
                ...
                canvas(
                    move |bounds, _, cx| {
                        entity.update(cx, |this, _| {
                            this.edit_input_origins
                                .insert(target, f32::from(bounds.origin.x) + 9.0);
                        });
                    },
                    |_, _, _, _| {},
                )
