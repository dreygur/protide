use gpui::{ClipboardItem, MouseButton, ParentElement, SharedString, Styled, div, prelude::*, px};

use crate::components::icons::{ICON_COPY, ICON_NETWORK, ICON_SM, ICON_TEAM, icon};
use crate::theme;
...
impl PresenceManager {
    ...
    pub fn render_presence_bar(&self, theme: &theme::Theme) -> gpui::AnyElement {
        ...
        div()
            ...
            .child(div().size(px(6.0)).rounded_full().bg(if enabled {
                    ...
                    div()
                        ...
                        .children(self.peers.iter().map(|peer| {
                            div()
                                ...
                                .child(div().size(px(5.0)).rounded_full().bg(if peer.is_active {
