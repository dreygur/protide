...
impl MockServerPanel {
    pub(super) fn render_add_form(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .child(div().flex().flex_wrap().items_center().gap_1().children(
                HttpMethod::all().iter().copied().enumerate().map(|(i, m)| {
                    ...
                    div()
                        ...
                        .border_1()
                        .when(is_selected, |el| {
                            el.border_color(color.opacity(0.6))
            ...
            .child(
                div()
                    ...
                    .child(div().w(px(80.0)).child(
                        Input::new(&self.status_input).with_size(gpui_component::Size::Small),
                    )),
            )
            .child(
                div()
                    ...
                    .child(Input::new(&self.mock_path_input)),
            )
            .child(
                div()
                    .mt_2()
                            ...
                            .child(
                                div()
                                    ...
                                    .when(is_recording, |el| {
                                        el.border_color(
                                            theme.colors.status_server_error.opacity(0.5),
                                        )
