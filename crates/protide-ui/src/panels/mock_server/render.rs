                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .border_1()
                            .when(is_running, |el| {
                                el.border_color(theme.colors.status_client_error.opacity(0.5))
                                    .bg(theme.colors.status_client_error.opacity(0.1))
                                    .text_color(theme.colors.status_client_error)
                            })
                            .when(!is_running, |el| {
                                el.border_color(theme.colors.accent.opacity(0.5))
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .items_center()
                            .gap_2()
                            .child(div().w_2().h_2().bg(if is_running {
