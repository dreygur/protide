                                            ...
                                            .on_mouse_down(
                                                ...
                                                cx.listener(move |this, _, _, cx| {
                                                    cx.write_to_clipboard(
                                                        ClipboardItem::new_string(b.clone()),
                                                    );
                                                    this.context_menu_pos = None;
                                                    cx.notify();
                                                }),
                                ...
                                |this, event: &gpui::MouseMoveEvent, _, cx| {
                                    if let Some((drag_id, start_x, start_w)) = this.resp_col_drag {
                                        ...
                                        let changed = match drag_id {
                                            0 => {
                                                let w = new_w.min(600.0);
                                                let c = (this.resp_header_col1_w - w).abs() > 0.5;
                                                this.resp_header_col1_w = w;
                                                c
                                            }
                                            1 => {
                                                let w = new_w.min(400.0);
                                                let c = (this.cookie_col1_w - w).abs() > 0.5;
                                                this.cookie_col1_w = w;
                                                c
                                            }
                                            2 => {
                                                let w = new_w.min(300.0);
                                                let c = (this.cookie_col3_w - w).abs() > 0.5;
                                                this.cookie_col3_w = w;
                                                c
                                            }
                                            3 => {
                                                let w = new_w.min(200.0);
                                                let c = (this.cookie_col4_w - w).abs() > 0.5;
                                                this.cookie_col4_w = w;
                                                c
                                            }
                                            _ => false,
                                        };
