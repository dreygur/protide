...
impl ResponsePanel {
    pub(super) fn render_extract_tab(
        &self,
        ...
        let is_json =
            response.body.trim().starts_with('{') || response.body.trim().starts_with('[');
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .bg(theme.colors.bg_tertiary)
                    .overflow_hidden()
                    .child(match &self.extraction_result {
                        Some(Ok(value)) => {
                            div()
                                .size_full()
                                .flex()
                                ...
                                .child(
                                    div().id("extract-value").flex_1().overflow_hidden().child(
                                        Input::new(&self.extraction_editor)
                                            .disabled(true)
                                            .appearance(false)
                                            .h_full(),
                                    ),
