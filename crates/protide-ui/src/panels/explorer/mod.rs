...
pub struct ExplorerPanel {
    ...
    pub(super) edit_undo_stack: std::collections::VecDeque<(EnvEditTarget, String, Range<usize>)>,
    pub(super) edit_redo_stack: std::collections::VecDeque<(EnvEditTarget, String, Range<usize>)>,
